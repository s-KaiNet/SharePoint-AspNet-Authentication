...
namespace AspNet.Core.SharePoint.Addin.Authentication.Common
{
	internal static class TokenHelper
	{
		...
		public static string GetContextTokenFromRequest(Microsoft.AspNetCore.Http.HttpRequest request)
		{
		...
		{
			return GetAccessToken(refreshToken, targetPrincipalName, targetHost, targetRealm).AccessToken;
		}
		...
		{
			var realm = GetRealmFromTargetUrl(applicationUri);
		...
		public static string ClientSigningCertificatePath;
		public static string ClientSigningCertificatePassword;
		public static X509Certificate2 ClientCertificate;
		public static X509SigningCredentials SigningCredentials;
